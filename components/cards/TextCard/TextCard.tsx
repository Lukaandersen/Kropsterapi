...
export default function TextCard (props) {
    ...
    return (
        ...
        <p className={` ${darkMode ? 'text-white' : 'text-primaryPurple'} max-w-[390px] text-center`}>For at nå ned til roden af hvad det er der gør ondt og hvorfor det bliver ved med at vende tilbage selvom at man har været en tur til massagekliniken. Så er det formegentligt noget psykisk der presser dig. Og hvis ikke det bliver løst ved roden, så kommer det tilbage.</p>
        </div>
        <div className="mx-6 my-2 flex flex-col items-center justify-center relative ">  
