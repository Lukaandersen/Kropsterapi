...
export default function BurgerMenu({ isOpen }) {
    return (
        <div className={`md:hidden absolute right-0 bg-lightBeige/50 mt-8 p-4 font-semibold ${isOpen ? 'block' : 'hidden'}`}>
            <ul className="text-primaryPurple gap-4 grid">
                ...
                <li className='hover:text-darkBlue'><a href="/hvad-er-kropsterapi">Hvad er <br></br> Kropsterapi?</a></li>
            </ul>
        </div>
    );
}