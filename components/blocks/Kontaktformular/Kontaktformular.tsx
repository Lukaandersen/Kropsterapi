      ...
      <form id="contactForm" onSubmit={handleSendEmail} className="flex flex-col gap-4 bg-primaryLight rounded-lg p-5">
        ...
        <div className=" md:flex md:justify-between md:px-[70px]">
          <div className="flex flex-col ">
            ...
            <input type="email" name="email" id="email" className="p-2 bg-gray-300 md:w-[250px]" required placeholder="Indtast din e-mailadresse" />
          </div>
          <div className="flex flex-col">
            <label htmlFor="phone" className="pt-4 md:pt-0 text-primaryPurple">
              Tlf nr
            </label>
            <input type="tel" id="phone" className=" p-2 bg-gray-300 md:w-[250px]" required placeholder="Indtast dit telefonnummer" />
          </div>
        </div>
        <div className="flex flex-col md:px-[70px]">
          ...
          <div className="text-primaryPurple bg-lightBeige font-josefin font-bold text-xl text-center py-3 px-11 rounded-xl shadow-md custom-shadow w-40 my-5 grid self-center">
