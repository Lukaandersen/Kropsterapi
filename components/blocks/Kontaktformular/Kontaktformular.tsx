...
export default function Kontaktformular(props) {
  return (
    <div className="flex flex-col items-center justify-center md:m-10 gap-8">
      ...
      <p className="text-left mx-10 md:mx-[314px]">Du kan sende mig en mail med dit spørgsmål, så vil jeg svare på det så godt som jeg kan. Du skal blot skrive dit spørgsmål i feltet nedenfor og tryk på "send", så svarer jeg hurtigst muligt</p>
      <form>
