export default function BookinButton() {
  return (
    ...
    <div className="flex justify-center items-center">
      <button className="text-primaryPurple bg-lightBeige font-josefin font-bold text-xl text-center m-5 py-5 px-11 rounded-xl shadow-md custom-shadow">Booking</button>
      <style jsx>{`
        .custom-shadow {
