export default function BeigeButton(props) {
  return (
    ...
    <div className="bg-mediumBeige">
      <button className="text-primaryPurple bg-mediumBeige font-josefin font-bold text-xl text-center py-3 px-11 rounded-xl shadow-md custom-shadow">{props.text}</button>
      <style jsx>{`
        .custom-shadow {
