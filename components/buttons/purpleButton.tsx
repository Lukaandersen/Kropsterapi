export default function PurpleButton(props) {
  ...
  return (
    ...
    <div className=" bg-primaryPurple">
      <button className="text-primaryLight bg-primaryPurple font-josefin font-bold text-xl text-center m-5 py-5 px-11 rounded-xl shadow-md custom-shadow" onClick={click}>
        {props.text}
      </button>
      <style jsx>{`
        .custom-shadow {
